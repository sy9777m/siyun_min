...
![Diagram of a linear unit.](./mfOlDR6.png)
...
![Computing with the linear unit.](./yjsfFvY.png)
...
![Three input connections: x0, x1, and x2, along with the bias.](./vyXSnlZ.png)
...
![image-20211006183116710](./image-20211006183116710.png)
...
![A stack of three circles in an input layer connected to two circles in a dense layer.](./2MA4iMV.png)
...
![A graph of the rectifier function. The line y=x when x>0 and y=0 when x<0, making a 'hinge' shape like '_/'.](./aeIyAlF.png)

The rectifier function has a graph that's a line with the negative part "rectified" to zero. Applying the function to the outputs of a neuron will put a *bend* in the data, moving us away from simple lines.

When we attach the rectifier to a linear unit, we get a **rectified linear unit** or **ReLU**. (For this reason, it's common to call the rectifier function the "ReLU function".) Applying a ReLU activation to a linear unit means the output becomes `max(0, w * x + b)`, which we might draw in a diagram like:

![Diagram of a single ReLU. Like a linear unit, but instead of a '+' symbol we now have a hinge '_/'. ](./eFry7Yu.png)

### Stacking dense layers

Now that we have some nonlinearity, let's see how we can stack layers to get complex data transformations.

![An input layer, two hidden layers, and a final linear layer.](./Y5iwFQZ.png)
...
![image-20211006184240869](./image-20211006184240869.png)
...
![A graph depicting error bars from data points to the fitted line..](./VDcvkZN.png)
...
![Fitting a line batch by batch. The loss decreases and the weights approach their true values.](./rFI1tIk.gif)
...
![image-20211006185813175](./image-20211006185813175.png)

![image-20211006185829299](./image-20211006185829299.png)

### Exercise

![image-20211006190149421](./image-20211006190149421.png)

![image-20211006190231572](./image-20211006190231572.png)
...
![A graph of training and validation loss.](./tHiVFnM.png)
...
![Two graphs. On the left, a line through a few data points with the true fit a parabola. On the right, a curve running through each datapoint with the true fit a parabola.](./eUF6mfo.png)
...
![A graph of the learning curves with early stopping at the minimum validation loss, underfitting to the left of it and overfitting to the right.](./eP0gppr.png)
...
![image-20211006191222318](./image-20211006191222318.png)

![image-20211006191311344](./image-20211006191311344.png)
...
![An animation of a network cycling through various random dropout configurations.](./a86utxY.gif)
...
![Graphs of accuracy and cross-entropy.](./DwVV9bR.png)
...
![The sigmoid graph is an 'S' shape with horizontal asymptotes at 0 to the left and 1 to the right. ](./FYbRvJo.png)
...
![image-20211006193905258](./image-20211006193905258.png)

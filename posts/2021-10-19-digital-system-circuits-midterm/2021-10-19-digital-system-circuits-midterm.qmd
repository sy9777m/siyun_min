...
![image-20211019142744917](./image-20211019142744917.png)
...
![image-20211019143049569](./image-20211019143049569.png)

## Converting from binary to decimal

![image-20211019143143025](./image-20211019143143025.png)

![image-20211019143152970](./image-20211019143152970.png)

![image-20211019143202562](./image-20211019143202562.png)

## Hexadecimal, hex

![image-20211019143232866](./image-20211019143232866.png)

![image-20211019143917198](./image-20211019143917198.png)

![image-20211019143934759](./image-20211019143934759.png)

![image-20211019143945772](./image-20211019143945772.png)
...
![image-20211019144427248](./image-20211019144427248.png)
...
![image-20211019144639391](./image-20211019144639391.png)

![image-20211019144643649](./image-20211019144643649.png)
...
![image-20211019144910074](./image-20211019144910074.png)

## The CMOS transistor

Basic switch in modern ICs

![image-20211019144929260](./image-20211019144929260.png)

## Boolean logic gates - building blocks for digital circuits

![image-20211019145027125](./image-20211019145027125.png)
...
![image-20211019145129771](./image-20211019145129771.png)

## Relating Boolean Algebra to digital design

![image-20211019145214878](./image-20211019145214878.png)

## NOT gate

![image-20211019145355561](./image-20211019145355561.png)

## OR gate

![image-20211019145417114](./image-20211019145417114.png)

## AND gate

![image-20211019145437083](./image-20211019145437083.png)

## Example that applies Boolean Algebra properties

![image-20211019150627132](./image-20211019150627132.png)

![image-20211019150731693](./image-20211019150731693.png)

## Truth table representation of Boolean functions

![image-20211019150804826](./image-20211019150804826.png)
...
![image-20211019151016513](./image-20211019151016513.png)
...
![image-20211019153813107](./image-20211019153813107.png)

![image-20211019153818241](./image-20211019153818241.png)

## Example: Sprinkler controller

![image-20211019153832137](./image-20211019153832137.png)

![image-20211019153936469](./image-20211019153936469.png)
...
![image-20211019154029357](./image-20211019154029357.png)
...
![image-20211019154401521](./image-20211019154401521.png)
...
![image-20211019154603116](./image-20211019154603116.png)
...
![image-20211019154756284](./image-20211019154756284.png)

![image-20211019154825139](./image-20211019154825139.png)

![image-20211019154835456](./image-20211019154835456.png)

![image-20211019154949871](./image-20211019154949871.png)

![image-20211019155001367](./image-20211019155001367.png)

## Additional considerations - non-ideal gate behavior - delay

![image-20211019155103235](./image-20211019155103235.png)

## Circuit delay and critical path

![image-20211019155118740](./image-20211019155118740.png)
...
![image-20211019155317792](./image-20211019155317792.png)
...
![image-20211019155433412](./image-20211019155433412.png)

## Boolean algebra properties

![image-20211019155449646](./image-20211019155449646.png)

## Example that applies Boolean algebra properties

![image-20211019155513430](./image-20211019155513430.png)

![image-20211019155525955](./image-20211019155525955.png)

![image-20211019155533495](./image-20211019155533495.png)

## Example applying DeMorgan's Law

![image-20211019155551514](./image-20211019155551514.png)

## Example applying properties

![image-20211019155604379](./image-20211019155604379.png)

## Complement of a function

![image-20211019155641260](./image-20211019155641260.png)
...
![image-20211019161704366](./image-20211019161704366.png)

## Tradeoff

Improves some, but worsens other, criteria of interest

![image-20211019161711162](./image-20211019161711162.png)

## Optimization and tradeoff

![image-20211019161722998](./image-20211019161722998.png)

## Combinational logic optimization and tradeoffs

Two-level size optimization using algebraic methods

![image-20211019161833339](./image-20211019161833339.png)
...
![image-20211019162046523](./image-20211019162046523.png)

![image-20211019162056139](./image-20211019162056139.png)

![image-20211019162103174](./image-20211019162103174.png)

![image-20211019162110035](./image-20211019162110035.png)

![image-20211019162117868](./image-20211019162117868.png)
...
![image-20211019162257738](./image-20211019162257738.png)

![image-20211019162303804](./image-20211019162303804.png)

![image-20211019162317921](./image-20211019162317921.png)
...
![image-20211019162415602](./image-20211019162415602.png)

![image-20211019162442823](./image-20211019162442823.png)

![image-20211019162512356](./image-20211019162512356.png)
...
![image-20211019162758455](./image-20211019162758455.png)

![image-20211019162808160](./image-20211019162808160.png)
...
![image-20211019163149377](./image-20211019163149377.png)
...
![image-20211019163252484](./image-20211019163252484.png)
...
![image-20211019164417861](./image-20211019164417861.png)

![image-20211019164457446](./image-20211019164457446.png)
...
![image-20211019164903281](./image-20211019164903281.png)
...
![image-20211019165132636](./image-20211019165132636.png)

## Verilog module

![image-20211019165205061](./image-20211019165205061.png)

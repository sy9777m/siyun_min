...
![image-20210930234612081](./image-20210930234612081.png)

## Probability Tree

![image-20210930234748270](./image-20210930234748270.png)

![image-20210930234946142](./image-20210930234946142.png)
$$
...
![image-20210930235347107](./image-20210930235347107.png)
...
![image-20210930235631538](./image-20210930235631538.png)

## Posterior probabilities (사후확률)

![image-20210930235730247](./image-20210930235730247.png)
...
![image-20211001000304270](./image-20211001000304270.png)

## Random variable

표본공간 S에 대해서 대응하는 real number를 연결하는 함수

![image-20211001000842677](./image-20211001000842677.png)

변수지만 사실상 함수의 개념. output을 실수와 mapping

### example

![image-20211001000928761](./image-20211001000928761.png)
...
![image-20211001001839852](./image-20211001001839852.png)

![image-20211001001903135](./image-20211001001903135.png)

![image-20211001001935111](./image-20211001001935111.png)

mapping된 특정 real number에만 값이 있는 것임

![image-20211001002008036](./image-20211001002008036.png)
...
![image-20211001002205724](./image-20211001002205724.png)

![image-20211001002244669](./image-20211001002244669.png)
$$
\\0 \le F_{X}(x) \le 1
\\F_{X}(\infty) = 1
\\F_{X}(-\infty) = 0
...
![image-20211001002524888](./image-20211001002524888.png)

![image-20211001002656255](./image-20211001002656255.png)
